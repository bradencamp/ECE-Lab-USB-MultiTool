...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        #might be prudent to split each layout definition into their own functions
        ...
        awgLayout.addWidget(ch1En,1,0)
        awgLayout.addWidget(ch2En,2,0)
        ...
        awgLayout.addWidget(ch1WaveSelect,1,1)
        awgLayout.addWidget(ch2WaveSelect,2,1)

        #AWG frequencies
        ch1Freq = ColorBox(colors[1])
        awgLayout.addWidget(ch1Freq,1,2)
        awgLayout.addWidget(QLabel("Frequency (Hz):"),1,2)
        ch2Freq = ColorBox(colors[2])
        awgLayout.addWidget(ch2Freq,2,2)
        awgLayout.addWidget(QLabel("Frequency (Hz):"),2,2)
            
        #AWG amplitueds
        ch1Amp = ColorBox(colors[3])
        awgLayout.addWidget(ch1Amp,1,3)
        awgLayout.addWidget(QLabel("Amplitude (V):"),1,3)
        ch2Amp = ColorBox(colors[4])
        awgLayout.addWidget(ch2Amp,2,3)        
        awgLayout.addWidget(QLabel("Amplitude (V):"),2,3)

        #AWG offsets
        ch1Off = ColorBox(colors[5])
        awgLayout.addWidget(ch1Off,1,4)
        awgLayout.addWidget(QLabel("Offset (V):"),1,4)
        ch2Off = ColorBox(colors[7])#6 doesn't play nice with black text
        awgLayout.addWidget(ch2Off,2,4)        
        awgLayout.addWidget(QLabel("Offset (V):"),2,4)

        awgPhase = ColorBox(colors[8])
        awgLayout.addWidget(awgPhase,1,5)
        awgLayout.addWidget(QLabel("Phase (°):"),1,5)
        awgLayout.addWidget(QLabel("Sync Status:"),2,5)
        ...
        awgLayout.addWidget(syncButton,2,6)
        ...
        dataLayout.addWidget(QLabel("Live Data",alignment = Qt.AlignmentFlag.AlignTop),0,0,-1,-1)
