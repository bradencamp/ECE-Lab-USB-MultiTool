...
class MainWindow(QMainWindow):
    ...
    def awgLayoutSetup(self):
        ...
        awgLayout.addWidget(ColorBox(QColor("#ffd54f")),0,0, -1,-1)#background for demonstration. Remove later colors[0]
        #enable channel
    ...
    def centerLayoutSetup(self):
        ...
        logicLayout.addWidget(ColorBox("#fcc0ab"),0,0,-1,-1)#background for demonstration. Remove later
        ...
        oscilloLayout.addWidget(ColorBox("#4caf50"),0,0,-1,-1)#background for demonstration. Remove later
